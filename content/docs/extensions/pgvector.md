...
The `pgvector` extension enables you to store vector embeddings and perform vector similarity search in Postgres. It's a natural fit for NLP applications, including those built on top of OpenAI's GPT models.
